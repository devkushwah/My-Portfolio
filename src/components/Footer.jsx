              ...
              <div class="flex items-center gap-4">
                <div class="social-button">
                  <button class="relative w-12 h-12 rounded-full group">
                    ...
                    >
                      <a href="https://www.instagram.com/devkushwahh/" target="_blank">                      <svg
                ...
                <div class="social-button">
                  <button class="relative w-12 h-12 rounded-full group">
                    ...
                    >
                      <a href="https://github.com/devkushwah" target="_blank">                      <svg
                        height="24"
                        width="24"
                        viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="social-button">
                  <button class="relative w-12 h-12 rounded-full group">
                    ...
                    <div
                      class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-black rounded-full"
                    >
                      <a href="https://x.com/devkushwah180" target="_blank">                      <svg
                        fill="none"
                        viewBox="0 0 22 22"
                        height="22"
                        width="22"
                ...
                <div class="social-button">
                  <button class="relative w-12 h-12 rounded-full group">
                    ...
                    >
                      <a href="https://www.linkedin.com/in/devkushwah/" target="_blank">
                        <svg
                          height="24"
                          width="24"
                          viewBox="0 0 24 24"
