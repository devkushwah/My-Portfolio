...
function Home() {
  ...
  const copyPasswordToClipboard = useCallback(() => {
    window.navigator.clipboard.writeText('devkushwah880@gmail.com')
    setIsCopied(true);
  ...
  const [text] = useTypewriter({
    words :[' Dev Kushwah', ' Full Stack Developer', 'Tech Enthusiast'],
    loop:{},
  });
            ...
            <div className="mx-2 bg-white flex flex-col space-y-10 rounded-3xl mt-28  dark:dark:bg-zinc-800 dark:text-white dark:border-gray-600 dark:border-[0.5px] pb-4 shadow-lg">
              <div >
                <div className='flex justify-between p-4'>
                  ...
                  <div class="group ">
                    <a href="https://github.com/devkushwah" target="_blank">
              ...
              <div className='flex flex-col justify-center items-center space-y-4 m-4 sm:m-6 rounded-3xl sm:p-8 p-4  '>
                  ...
                  <a href="https://wa.me/9644889648?text=Hello%20there!" target="_blank" className="flex text-black flex-row gap-2 justify-center items-center bg-green-500 hover:bg-green-400 hover:text-gray-700 p-2  rounded">
