        ...
        <div className="fixed top-0 w-full lg:w-2/3 z-50" >
          <div className="mx-2 p-2 bg-white sm:px-18 flex mt-2 rounded-2xl dark:bg-zinc-700 dark:text-white shadow-sm border dark:border-gray-500">
            ...
            <div className="flex items-center gap-3.5 justify-around pr-3 group">
              ...
              <a href="https://www.linkedin.com/in/devkushwah/" target='_blank' className="hidden dark:bg-cyan-500 sm:flex flex-row justify-center items-center px-3 py-2 text-lg rounded-xl gap-2 bg-cyan-600 text-white dark:text-black"><BsLinkedin/>Linkedin</a>
            </div>
          </div>
        </div>
